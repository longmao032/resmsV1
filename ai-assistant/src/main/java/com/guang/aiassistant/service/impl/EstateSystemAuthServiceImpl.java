...
@Service
public class EstateSystemAuthServiceImpl implements EstateSystemAuthService {

    private static final Logger log = LoggerFactory.getLogger(EstateSystemAuthServiceImpl.class);
    ...
    public EstateSystemAuthServiceImpl(
